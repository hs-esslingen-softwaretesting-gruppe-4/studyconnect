...
public class TaskService {
    ...
    public ResponseEntity<TaskResponseDTO> createTask(Long groupId, TaskRequestDTO taskRequestDTO) {
        ...
        task.setGroup(groupRepository.findById(groupId).orElseThrow(() -> new NotFoundException("Group not found")));
        ...
        task.setCreatedBy(this.userRepository.findById(taskRequestDTO.getCreatedById())
