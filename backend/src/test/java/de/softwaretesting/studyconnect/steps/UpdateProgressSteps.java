...
public class UpdateProgressSteps {
  ...
  public void theUserEntersTheStatusInTheTaskDetailView() {
    /* SKIP */
    // Manual status input not yet implemented
    /* try {
  ...
  public void theUserGetsAnErrorMessageWithDefinedStatuses() {
    ...
    // assertTrue(resultMessage.contains("IN_PROGRESS"),"Error message should list IN_PROGRESS
    // status");
    // assertTrue(resultMessage.contains("COMPLETED"), "Error message should list COMPLETED
    // status");
  ...
  public void theUserGetsAMessageWithTheReportAndInstructions() {
    ...
    // assertTrue(resultMessage.contains("try again") || resultMessage.contains("contact
    // support"),"Message should provide instructions for user");
  }
