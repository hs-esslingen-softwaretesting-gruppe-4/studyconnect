...
/**
 * Step Definitions für die create-task.feature Szenarien. Implementiert die Gherkin Steps mit
...
public class CreateTaskStepDefinitions {
  ...
  public void the_new_task_has_the_following_properties(DataTable dataTable) {
    ...
    assertThat(currentTask.getPriority().toString())
        .isEqualToIgnoringCase(expected.get("priority"));
  ...
  public void the_new_task_has_priority_set_to_by_default(String expectedPriority) {
    assertThat(currentTask.getPriority())
        .isEqualTo(Task.Priority.valueOf(expectedPriority.toUpperCase()));
  }
  ...
  public void the_new_task_has_status_set_to_by_default(String expectedStatus) {
    assertThat(currentTask.getStatus())
        .isEqualTo(Task.Status.valueOf(expectedStatus.toUpperCase()));
  }
  ...
  public void the_task_appears_in_the_group_s_shared_task_list() {
    ...
    boolean foundInGroupTasks =
        taskRepository.findByGroupId(group.getId()).stream()
