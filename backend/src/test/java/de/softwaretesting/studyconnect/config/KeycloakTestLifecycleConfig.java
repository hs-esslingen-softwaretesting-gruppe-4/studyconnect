...
/**
 * Test configuration that manages Keycloak realm lifecycle for integration tests. Creates the test
 * realm and test users before tests run, and cleans up after.
 */
@TestConfiguration
@Profile("test")
